...
if (_objects isEqualTo []) exitWith {
	[format["Failed to apply %1 Arsenal: No object given! %2", _filter, _objects], "core\functions\fn_arsenal.sqf"] call bnb_es_core_fnc_log;
};
...

{
	...
	[format["Added %1 filtered arsenal to %2", _filter, _x], "core\functions\fn_arsenal.sqf"] call bnb_es_core_fnc_log;
} forEach _objects;
