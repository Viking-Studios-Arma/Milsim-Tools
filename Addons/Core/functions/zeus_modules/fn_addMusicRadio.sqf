/* ----------------------------------------------------------------------------
Function: oni_core_fnc_addMusicRadio
...
if (isNull (_objects select 0)) then {
	...
	if (_objects isEqualTo []) exitWith {[localize "STR_AMAE_NO_OBJECT_SELECTED", "error"] call oni_core_fnc_notifyZeus};
};
...
[format ["Added music radio to %1", _objects], "core\functions\zeus_modules\fn_addMusicRadio.sqf"] call oni_core_fnc_log;

// Show Message
["Music Radio added!"] call oni_core_fnc_notifyZeus;
