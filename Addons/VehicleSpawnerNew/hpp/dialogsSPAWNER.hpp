...
class VS_Spawner {
    ...
    class controls {
        ...
        class VS_CTRLGRP: RscControlsGroupVSSpawner {
            ...
            class Controls {
                class VS_list: RscListboxVSSpawner {
                    ...
                    w = 0.295312 * safezoneW;
                    h = 0.378 * safezoneH;
                    onMouseButtonClick = "call VS_fnc_Refresh";
                };
            };
        };
        ...
        class VS_CategoryChoice: RscComboVSSpawner {
            idc = 2100;
            text = ""; //--- ToDo: Localize;
            ...
            h = 0.028 * safezoneH;
            onLBSelChanged = "_VSvalue = _this select 1; [_VSvalue] call VS_fnc_SelectType;";
        };
        ...
        class VS_DLCSelect: RscComboVSSpawner {
            ...
            onLBSelChanged = "_VSvalue = _this select 1; [_VSvalue] call VS_fnc_UserSelectedDLC;";
        };
        ...
        class VS_FactionSelect: RscComboVSSpawner {
            ...
            w = 0.124687 * safezoneW;
            h = 0.028 * safezoneH;
            tooltip = $STR_VS_SPAWNER_SELECTFACTIONTOOLTIP;
            onLBSelChanged = "_VSvalue = _this select 1; [_VSvalue] call VS_fnc_UserSelectedFaction;";
        };
    };
};
////////////////////////////////////////////////////////
