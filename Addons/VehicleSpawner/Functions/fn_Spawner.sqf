/*
Function name: VS_core_fnc_Spawner
Author: Mr H.
Description: 
...
Example(s):
[this] call VS_core_fnc_Spawner;
or
[laptop1,helipad1] call VS_core_fnc_Spawner;
or
[this,helipad1,"Air"] call VS_core_fnc_Spawner;
*/
...
if (isNil "_spawnPosObject") then {[] Spawn { waitUntil {Time>1};systemChat "VS_core_Spawner error: No spawn was defined spawn will be set behind source object";}};
if !(_checkParams) then {[] Spawn {waitUntil {Time>1};systemChat "VS_core_Spawner error: wrong type defined. Type must be 'All' or 'Air' or 'Land'. Default value will be set to 'all'";}};
