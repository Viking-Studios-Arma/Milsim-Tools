/*
Function name: VS_core_fnc_RefreshMainList
Author: Mr H.
Description: refreshes the main list of the interface
Return value: None
Public: No
Parameters: None
Example(s): call VS_core_fnc_Spawner_RefreshMainList;
*/
...
_array = call VS_core_fnc_Spawner_FilterAll;
...
_dlcPic = "x\VS_C\spawner\Paa\arma3.paa";};
...
_VSvalue = _x;
lbSetData [1500, _index, _VSvalue]; 
};
} forEach _array;
