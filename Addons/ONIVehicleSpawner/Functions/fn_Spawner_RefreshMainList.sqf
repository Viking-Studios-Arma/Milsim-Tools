/*
Function name: oni_core_fnc_RefreshMainList
Author: Mr H.
Description: refreshes the main list of the interface
Return value: None
Public: No
Parameters: None
Example(s): call oni_core_fnc_Spawner_RefreshMainList;
*/
...
_array = call oni_core_fnc_Spawner_FilterAll;
...
_onivalue = _x;
lbSetData [1500, _index, _onivalue]; 
};
} forEach _array;
