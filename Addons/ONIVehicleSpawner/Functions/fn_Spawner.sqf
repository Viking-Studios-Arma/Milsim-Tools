/*
Function name: oni_core_fnc_Spawner
Author: Mr H.
Description: 
...
Example(s):
[this] call oni_core_fnc_Spawner;
or
[laptop1,helipad1] call oni_core_fnc_Spawner;
or
[this,helipad1,"Air"] call oni_core_fnc_Spawner;
*/
...
if (isNil "_spawnPosObject") then {[] Spawn { waitUntil {Time>1};systemChat "oni_coreSpawner error: No spawn was defined spawn will be set behind source object";}};
if !(_checkParams) then {[] Spawn {waitUntil {Time>1};systemChat "oni_coreSpawner error: wrong type defined. Type must be 'All' or 'Air' or 'Land'. Default value will be set to 'all'";}};
