/*
Function name: oni_core_fnc_Spawner_OpenInterface
Author: Mr H.
Description: Opens and fills the spawner interface
Return value: none
Public: No
Parameters: None
Example(s): oni_core_fnc_Spawner_OpenInterface;
*/

///creates the dialog
createdialog "oniSpawner";
/////////////////////
...
////localization vars
_locAll = localize "STR_ONI_SPAWNER_ALL_MALE";
_locChops= localize "STR_ONI_SPAWNER_CHOPPERS";
_locPlanes = localize "STR_ONI_SPAWNER_PLANES";
_locUAV = localize "STR_ONI_SPAWNER_DRONES";
_locCrs = localize "STR_ONI_SPAWNER_CARS";
_locTrucks = localize "STR_ONI_SPAWNER_TRUCKS";
_locAPC = localize "STR_ONI_SPAWNER_APCs";
_locMRAP = localize "STR_ONI_SPAWNER_MRAPS";
_locTanks= localize "STR_ONI_SPAWNER_TANKS";
_locSea = localize "STR_ONI_SPAWNER_MARITIME";
///
switch (true) do {
case (_Type == "All") : {
