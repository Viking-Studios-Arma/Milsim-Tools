class CfgPatches {
	class MRHMilsimTools{
		...
		versionAct = "call compile preProcessFileLineNumbers 'about.sqf'";
		author = "Mr H.";
      authors[]= {"Mr H."};
...
class Extended_PreInit_EventHandlers
{
   ...
   {
      init = "call compile preProcessFileLineNumbers 'Functions\SettingsPreInit\CBASettings.sqf'";
   }; 
   class MRHMilsimTools_CBA_Settings_keybinds
   {
      init = "call compile preProcessFileLineNumbers 'Functions\SettingsPreInit\CBAKeys.sqf'";
   };    
...
class Extended_PostInit_EventHandlers
{
   ...
   {
      clientInit = "call compile preProcessFileLineNumbers 'Functions\InitFunctions\fn_MilsimTools_Core_SetPlayerIntel.sqf'";
   };
   
   class MRHMilsimTools_Core_InitPlayerLocal
   {
      clientInit = "call compile preProcessFileLineNumbers 'Functions\InitFunctions\XEHclient.sqf'";
   };
   
   class MRHMilsimTools_Core_PlayersRegistry
   {
      serverInit = "call compile preProcessFileLineNumbers 'Functions\InitFunctions\XEHserver.sqf'";
   };
   class MRHMilsimTools_Core_Init
   {
      init = "call compile preProcessFileLineNumbers 'Functions\InitFunctions\XEHinit.sqf'";
   };
...
{
#include "cfghpp\cfgnotifications.hpp"
};
////=============fincfgNotifications
//===cfgMRHRanks
#include "cfghpp\cfgMRHrankpictures.hpp"
//==========

#include "cfghpp\cfgMRHcompositions.hpp"
#include "cfghpp\cfg3DEN.hpp"
...
class cfgVehicles
{
   #include "cfghpp\cfgVehicles.hpp"
};